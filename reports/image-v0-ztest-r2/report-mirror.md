...
| `combo-vdev-phys-gone-and-member-missing` | refused | defect | defect | yes | told about t0-mirror-0.img; pool: list exit 1: zvolrescue: --assume-member /tmp/golden-combo-vdev-phys-gone-and-member-missing-pfn13n_f/t0-mirror-0.img: no scanned pool is missing a member |
